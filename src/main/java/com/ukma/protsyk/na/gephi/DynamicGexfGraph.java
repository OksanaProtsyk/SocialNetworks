...
public class DynamicGexfGraph {
    ...
    public static String FILE_PATH = "src/main/webapp/resources/static/assets/data/graph.gexf";
    ...
    public static void generateGraph(UserActor act, List<UserXtrCounters> users, Map<String, List<String>> users2) {
        Gexf gexf = new GexfImpl();
        Calendar date = Calendar.getInstance();
